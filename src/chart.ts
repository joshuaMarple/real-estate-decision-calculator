...
const yearsValue = document.getElementById('years-value') as HTMLSpanElement;

function generateData(years: number): ChartData {
    const labels: string[] = [];
